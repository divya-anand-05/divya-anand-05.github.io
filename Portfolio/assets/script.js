...
const updateSlider = () => {
  const slideWidth = slides.children[0].clientWidth; // Get the width of one slide
...
prevButton.addEventListener('click', () => {
  if (currentIndex > 0) {
    ...
    currentIndex = slides.children.length - 1; // Loop back to the last slide
  }
  updateSlider();
});

// Update the slider position on window resize for responsiveness
